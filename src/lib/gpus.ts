...
/**
 * Memory budget (GiB) a model may actually occupy. A selected MIG slice wins;
 * a unified-memory device already stores its usable slice in vramGiB; a
 * discrete board takes the driver-reserve haircut.
 */
