...
const en: Dict = {
  ...
  "nav.group.sizing": "Sizing",
  "nav.group.serve": "Serving",
  "nav.group.model": "Model",
  "nav.group.learn": "Learn",
  "scen.single": "Single user",
  "scen.chat": "Chat service",
  "scen.long": "Long context",
  "scen.batch": "Batch job",
  "con.total": "Total VRAM",
  "con.estimated": "estimated",
  "con.gibNeeded": "GiB needed",
  "con.gaugeCaption": "{p}% — {usable} GiB usable",
  "con.headroom": "Headroom",
  "con.maxUsers": "Max users",
  "con.atCtx": "{x} context",
  "con.precision": "Precision options",
  "con.againstCapacity": "against {gpu} capacity",
  "con.selected": "selected",
  "con.dt.bf16": "full precision",
  "con.dt.fp8": "native quantized",
  "con.dt.int8": "common quantized",
  "con.dt.int4": "AWQ / GPTQ",
  "con.fits": "Fits",
  "con.short": "Too big",
  "con.tight": "Tight",
  "con.nCards": "{n}x cards",
  "con.tickHint": "The white line is the selected card's usable memory. Click a row to switch precision.",
  "con.hardware": "Hardware fit",
  "con.hwNote": "5% of a discrete card is reserved for the driver. On unified-memory devices the GPU share is capped separately.",
  "con.savings": "Ways to free memory",
  "con.savingsNote": "from the current settings",
  "con.currentlyFits": "currently fits",
  "con.needFree": "{x} GiB over",
  "con.applyBest": "Apply best",
  "con.applied": "Applied",
  "con.col.change": "Change",
  "con.col.gain": "Saves",
  "con.col.what": "What happens",
  "con.col.cost": "Cost",
  "con.col.newTotal": "New total",
  "con.col.result": "Result",
  "con.col.ctx": "Context",
  "con.col.users": "Users",
  "con.col.kv": "KV",
  "con.col.overhead": "Overhead",
  "con.sv.kvFp8": "KV cache to FP8",
  "con.sv.wInt4": "Weights to INT4",
  "con.sv.ctxHalf": "Halve the context",
  "con.sv.usersHalf": "Halve concurrency",
  "con.svCode.kvFp8": "kv-cache-dtype",
  "con.svCode.wInt4": "weight-dtype",
  "con.svCode.ctxHalf": "max-model-len",
  "con.svCode.usersHalf": "concurrency",
  "con.svWhat.kvFp8": "KV cache halves",
  "con.svWhat.wInt4": "Weights shrink 4x",
  "con.svWhat.ctxHalf": "KV drops linearly",
  "con.svWhat.usersHalf": "KV drops in step",
  "con.svCost.kvFp8": "Measurable accuracy hit",
  "con.svCost.wInt4": "Largest quality risk",
  "con.svCost.ctxHalf": "Long documents get cut",
  "con.svCost.usersHalf": "Half the throughput",
  "con.capacity": "What fits on this card",
  "con.concurrentUsers": "concurrent users",
  "con.usageLine": "{x} / {y} GiB · {ctx} × {n} requests",
  "con.capNote": "KV cache grows linearly with context and concurrency; weights stay fixed. At the limit the first thing to cut is context, not weight precision.",
  "con.ins.overTitle": "{gpu} cannot hold this — {x} GiB over.",
  "con.ins.overBody": "“{action}” alone frees {x} GiB and brings the total to {total} GiB.",
  "con.ins.overNoFix": "A larger card or tensor parallelism is needed.",
  "con.ins.kvTitle": "Memory now sits in the KV cache, not the weights: {p}% of the total.",
  "con.ins.kvBody": "Here the decision is context and concurrency, not quantization — FP8 KV cache frees {x} GiB in one move.",
  "con.ins.okTitle": "The model runs on {gpu} with {x} GiB to spare.",
  "con.ins.okBody": "That headroom holds at {ctx} context; past it the KV cache fills first.",
  "con.model": "Model",
  "con.scenario": "Scenario",
  "con.col.weight": "Weights",
  "con.warnHint": "A red dot marks a choice that would not fit the selected card.",
  "con.changeModel": "Change model",
  "con.close": "Close",
  "con.noModel": "Manual entry",
...
const tr: Dict = {
  ...
  "nav.group.sizing": "Boyutlandırma",
  "nav.group.serve": "Servis",
  "nav.group.model": "Model",
  "nav.group.learn": "Öğren",
  "scen.single": "Tek kullanıcı",
  "scen.chat": "Sohbet servisi",
  "scen.long": "Uzun bağlam",
  "scen.batch": "Toplu iş",
  "con.total": "Toplam VRAM",
  "con.estimated": "tahmini",
  "con.gibNeeded": "GiB gerekli",
  "con.gaugeCaption": "%{p} — {usable} GiB kullanılabilir",
  "con.headroom": "Boşta kalan",
  "con.maxUsers": "Maks kullanıcı",
  "con.atCtx": "{x} context",
  "con.precision": "Hassasiyet seçenekleri",
  "con.againstCapacity": "{gpu} kapasitesine karşı",
  "con.selected": "seçili",
  "con.dt.bf16": "tam hassasiyet",
  "con.dt.fp8": "yerel quantize",
  "con.dt.int8": "yaygın quantize",
  "con.dt.int4": "AWQ / GPTQ",
  "con.fits": "Sığar",
  "con.short": "Yetmez",
  "con.tight": "Sınırda",
  "con.nCards": "{n}× kart",
  "con.tickHint": "Beyaz çizgi seçili kartın kullanılabilir belleği. Bir satıra tıklayarak o hassasiyete geç.",
  "con.hardware": "Donanım uyumu",
  "con.hwNote": "Ayrık kartların %5'i sürücüye ayrılır. Unified bellekli cihazlarda GPU'ya düşen pay ayrıca sınırlıdır.",
  "con.savings": "Yer açmanın yolları",
  "con.savingsNote": "şu anki ayara göre",
  "con.currentlyFits": "şu an sığıyor",
  "con.needFree": "{x} GiB fazla",
  "con.applyBest": "En iyisini uygula",
  "con.applied": "Uygulandı",
  "con.col.change": "Değişiklik",
  "con.col.gain": "Kazanç",
  "con.col.what": "Ne oluyor",
  "con.col.cost": "Bedeli",
  "con.col.newTotal": "Yeni toplam",
  "con.col.result": "Sonuç",
  "con.col.ctx": "Context",
  "con.col.users": "Kullanıcı",
  "con.col.kv": "KV",
  "con.col.overhead": "Ek yük",
  "con.sv.kvFp8": "KV cache → FP8",
  "con.sv.wInt4": "Ağırlık → INT4",
  "con.sv.ctxHalf": "Context'i yarıya indir",
  "con.sv.usersHalf": "Eşzamanlılığı yarıya indir",
  "con.svCode.kvFp8": "kv-cache-dtype",
  "con.svCode.wInt4": "weight-dtype",
  "con.svCode.ctxHalf": "max-model-len",
  "con.svCode.usersHalf": "concurrency",
  "con.svWhat.kvFp8": "KV cache yarıya iner",
  "con.svWhat.wInt4": "Ağırlıklar 4× küçülür",
  "con.svWhat.ctxHalf": "KV doğrusal düşer",
  "con.svWhat.usersHalf": "KV aynı oranda azalır",
  "con.svCost.kvFp8": "Ölçülebilir doğruluk kaybı",
  "con.svCost.wInt4": "Kalitede en büyük risk",
  "con.svCost.ctxHalf": "Uzun doküman kesilir",
  "con.svCost.usersHalf": "Yarı throughput",
  "con.capacity": "Bu kartta ne sığar",
  "con.concurrentUsers": "eşzamanlı kullanıcı",
  "con.usageLine": "{x} / {y} GiB · {ctx} × {n} istek",
  "con.capNote": "KV cache context ve eşzamanlılıkla doğrusal büyür; ağırlıklar sabit kalır. Sınıra dayandığında ilk düşürülecek şey ağırlık hassasiyeti değil, context olur.",
  "con.ins.overTitle": "{gpu} bu ayarla yetmiyor — {x} GiB fazla.",
  "con.ins.overBody": "Tek başına “{action}” {x} GiB kazandırır ve toplamı {total} GiB seviyesine indirir.",
  "con.ins.overNoFix": "Daha büyük bir karta ya da tensor paralelliğe geçmek gerekiyor.",
  "con.ins.kvTitle": "Bellek artık ağırlıklarda değil, KV cache'te: toplamın %{p}'i.",
  "con.ins.kvBody": "Bu noktada belirleyici olan quantization değil, context ve eşzamanlılık — FP8 KV cache tek hamlede {x} GiB açar.",
  "con.ins.okTitle": "Model {gpu} üzerinde {x} GiB boşlukla çalışıyor.",
  "con.ins.okBody": "Bu boşluk {ctx} context'te geçerli; ötesinde önce KV cache dolar.",
  "con.model": "Model",
  "con.scenario": "Senaryo",
  "con.col.weight": "Ağırlık",
  "con.warnHint": "Kırmızı nokta, seçili karta sığmayacak seçeneği işaretler.",
  "con.changeModel": "Modeli değiştir",
  "con.close": "Kapat",
  "con.noModel": "Manuel giriş",
